...
CollisionDetector.prototype.collisions = function(a) {
    ...
    var aY1 = Math.floor(a.vector.y.pos / 50) - a.extents.length-1;
    var aY2 = Math.ceil(a.vector.y.pos / 50) ;
    return _.find(this.objects, function(b) {
        ...
        var bY1 = Math.floor(b.vector.y.pos / 50) - b.extents.length-1;
        var bY2 = Math.ceil(b.vector.y.pos / 50) ;
